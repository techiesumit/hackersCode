...
import com.example.json.pojo.Person;
...
public class JsonConverter {
    public static void main(String[] args) {
        ...
        //Convert Java Plain Object into JSON
			/*
			 * Person personPojo = new Person(); personPojo.setFirstName("Sergey");
			 * personPojo.setLastName("Kargopolov"); Gson gsonBuilder = new
			 * GsonBuilder().create(); String jsonFromPojo = gsonBuilder.toJson(personPojo);
			 * 
